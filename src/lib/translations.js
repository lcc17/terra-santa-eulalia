export const translations = {
  es: {
    ...
    treatmentsPage: {
      ...
      hairRituals: {
        title: "Rituales Orgánicos Capilares",
        desc: "Recupera la fuerza y salud de tu cabello con barros y plantas.",
        list: [
          {
            id: "ritual-detox",
            title: "Ritual Detox",
            desc: "Este tratamiento limpia en profundidad el cuero cabelludo gracias a la mezcla de plantas medicinales desintoxicantes. Indicado de manera especial para problemas de dermatitis seborreica, descamación, caspa y exceso de grasa capilar.",
            extra:
              "Disfruta durante la exposición de un relajante masaje facial o de pies, tú elijes.",
            duration: "50 min",
            price: "85€",
          },
          {
            ...
            desc: "El objetivo de este ritual es dar a tu cabello la fuerza y vitalidad que necesita. Si sientes que tu cabello está débil y apenas tiene cuerpo y le falta vida, sin duda este es tu ritual. Sentir el aroma de las plantas ayurvédicas en tu cabello hará que conectes con la par y armonía que necesitas.",
            extra: "Incluye un relajante masaje facial o de pies, tú elijes.",
            duration: "60 min",
            price: "95€",
            isHighlight: true,
          },
          {
            ...
            desc: "¿Echas de menos la flexibilidad y estructura de tus rizos? La mezcla de hierbas que aplicamos en este ritual ayudará a tu cabello a recuperar la estructura perdida del rizo. ¿Rizo sin vida? ya no, gracias a la acción de nuestra mezcla de plantas.",
            extra:
              "Disfruta durante la exposición de un relajante masaje facial o de pies, tú elijes.",
            duration: "50 min",
            price: "85€",
    ...
    services: {
      ...
      capillaryDesc: "Diagnóstico botánico y recuperación molecular.",
    ...
    capillaryPage: {
      ...
      title: "Terapia Orgánica Capilar",
      ...
      ritualsTitle: "Rituales Orgánicos Capilares",
      ritualsDesc:
        "Tratamientos específicos para cada necesidad. Protocolos botánicos de alta eficacia.",
      ritualsList: [
        {
          id: "ritual-detox",
          title: "Ritual Detox",
          desc: "Este tratamiento limpia en profundidad el cuero cabelludo gracias a la mezcla de plantas medicinales desintoxicantes. Indicado de manera especial para problemas de dermatitis seborreica, descamación, caspa y exceso de grasa capilar. Disfruta durante la exposición de un relajante masaje facial o de pies, tú elijes.",
          duration: "50 min",
          price: "85€",
        },
        {
          id: "ritual-fuerte",
          title: "Ritual Siempre Fuerte y Vital",
          desc: "El objetivo de este ritual es dar a tu cabello la fuerza y vitalidad que necesita. Si sientes que tu cabello está débil y apenas tiene cuerpo y le falta vida, sin duda este es tu ritual. Sentir el aroma de las plantas ayurvédicas en tu cabello hará que conectes con la par y armonía que necesitas. Incluye un relajante masaje facial o de pies, tú elijes.",
          duration: "60 min",
          price: "95€",
        },
        {
          id: "ritual-rizos",
          title: "Ritual Rizos Perfectos",
          desc: "¿Echas de menos la flexibilidad y estructura de tus rizos? La mezcla de hierbas que aplicamos en este ritual ayudará a tu cabello a recuperar la estructura perdida del rizo. ¿Rizo sin vida? ya no, gracias a la acción de nuestra mezcla de plantas. Disfruta durante la exposición de un relajante masaje facial o de pies, tú elijes.",
          duration: "50 min",
          price: "85€",
        },
      ],
    ...
    productsList: [
      ...
      },
      {
        ...
        usage:
          "Aplicar sobre el cabello húmedo, masajear suavemente el cuero cabelludo y el cabello. Aclarar con abundante agua.",
        precautions: "Uso externo. Evitar el contacto con los ojos.",
        img: "/images/products/terra_santa_shampoo_fidelis.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
  ...
  en: {
    ...
    cards: {
      ...
      therapyTitle: "ORGANIC\HHAIR THERAPY",
        ...
        list: [
          {
            id: "ritual-detox",
            title: "Detox Ritual",
            desc: "This treatment deeply cleanses the scalp thanks to a blend of detoxifying medicinal plants. Specially indicated for problems such as seborrheic dermatitis, flaking, dandruff and excess oil.",
            extra:
              "Enjoy a relaxing facial or foot massage while the treatment works, you choose.",
            duration: "50 min",
            price: "85€",
          },
          {
            ...
            desc: "The aim of this ritual is to give your hair the strength and vitality it needs. If you feel your hair is weak, lacks body and feels lifeless, this is undoubtedly the ritual for you. Feeling the aroma of Ayurvedic plants on your hair will connect you with the peace and harmony you need.",
            extra: "Includes a relaxing facial or foot massage, you choose.",
            duration: "60 min",
            price: "95€",
          },
          {
            ...
            desc: "Do you miss the flexibility and structure of your curls? The blend of herbs applied in this ritual will help your hair recover its lost curl structure. Lifeless curls? Not anymore, thanks to the action of our plant blend.",
            extra:
              "Enjoy a relaxing facial or foot massage while the treatment works, you choose.",
            duration: "50 min",
            price: "85€",
    ...
    productsList: [
      {
        id: "planta-fortalecedora",
        name: "Strengthening & Shine Plant",
        category: "Powder Treatment",
        type: "Cassia Obovata",
        price: 28,
        desc: "Known as 'Neutral Henna'. It does not dye the hair, but helps provide shine and strengthen the hair fiber.",
        ingredients: "Cassia Obovata Leaf Powder.",
        usage:
          "Mix 2 or 3 tablespoons of the plant powder with warm water until a creamy paste is formed. Optionally, add 3-4 teaspoons of a cold-pressed vegetable oil to nourish the hair with additional vitamins. Allow it to cool and apply from the scalp to the ends of the hair. Leave it on for approximately 1 hour before washing with a mild shampoo.",
        precautions:
          "For external use only. Avoid direct contact with eyes. This product does not lighten the hair as it contains no oxidizing agents or chemical bleaching agents. A skin sensitivity test is recommended to ensure there are no allergies to this product. Results may vary from one hair type to another depending on the base color and texture of each hair. Store in a cool, dry place away from sunlight.",
        img: "/images/products/terra_santa_planta_fortalecedora_brillante.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "planta-rubio-luminoso",
        name: "Luminous Blonde Plant",
        category: "Vegetal Coloring",
        type: "Ayurvedic Blend",
        price: 28,
        desc: "Plant-based blend to enhance golden reflections in light hair while providing a natural treatment.",
        ingredients:
          "Cassia Italica Leaf Powder, Lawsonia Inermis Powder, Chamomilla Recutita Flower Powder, Curcuma Longa Root Powder.",
        usage:
          "In a large bowl, gradually mix the powder with warm water (approximately 30°C) until a yogurt-like consistency is achieved. Apply immediately to clean, dry, and thoroughly detangled hair, from roots to ends. Leave on for 20 to 40 minutes depending on the desired color intensity. Then rinse and wash with a mild shampoo.",
        precautions:
          "For external use only. Avoid direct contact with eyes. This product does not lighten the hair as it contains no oxidizing agents or chemical bleaching agents. A skin sensitivity test is recommended before use to rule out possible allergic reactions. Results may vary depending on the base color and texture of each hair type. Store in a cool, dry place protected from sunlight.",
        img: "/images/products/terra_santa_planta_rubio_luminoso.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "planta-rubio-miel",
        name: "Honey Blonde Plant",
        category: "Vegetal Coloring",
        type: "Ayurvedic Blend",
        price: 28,
        desc: "Warm and sweet shade for blonde or light brown hair looking for natural golden tones.",
        ingredients:
          "Cassia Italica Leaf Powder, Lawsonia Inermis Powder, Indigofera Tinctoria Leaf Powder, Aloe Barbadensis Leaf Powder, Emblica Officinalis Fruit Powder, Ziziphus Jujuba Powder.",
        usage:
          "In a large bowl, gradually mix the plants with warm water at approximately 30°C until the mixture reaches a yogurt-like consistency. Apply immediately to clean, dry, and thoroughly detangled hair from roots to ends. Leave on for 40–50 minutes depending on the desired color intensity before rinsing with water.",
        precautions:
      ...
      {
        id: "planta-puro-cobre",
        name: "Pure Copper Plant",
        category: "Vegetal Coloring",
        type: "100% Organic",
        price: 28,
        desc: "High-quality pure henna that provides an intense copper tone, strength, and spectacular shine.",
        ingredients: "Lawsonia Inermis Leaf Powder.",
        usage:
          "In a large bowl, gradually mix the plants with warm water at approximately 50–70°C until the mixture reaches a yogurt-like consistency. Apply to clean, dry, thoroughly detangled hair from roots to ends and leave on for 60–90 minutes depending on the desired color intensity before washing only with a mild shampoo.",
        precautions:
          "For external use only. Avoid direct contact with eyes. This product does not lighten the hair as it contains no oxidizing agents or chemical bleaching agents. A skin sensitivity test is recommended to ensure there are no allergies to this product. Results may vary from one hair type to another depending on the base color and texture. Store in a cool, dry place protected from sunlight.",
        img: "/images/products/terra_santa_planta_puro_cobre.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      {
        id: "planta-marron-dorado",
        name: "Golden Brown Plant",
        category: "Vegetal Coloring",
        type: "Ayurvedic Blend",
        price: 28,
        desc: "Plant-based blend to achieve warm and natural golden brown tones. Provides color nuances, shine, and body to the hair.",
        ingredients:
          "Lawsonia Inermis Powder, Indigofera Tinctoria Leaf Powder, Juglans Regia Shell Powder, Emblica Officinalis Fruit Powder, Ziziphus Jujuba Powder, Aloe Barbadensis Leaf Powder, Curcuma Longa Root Powder.",
        usage:
          "In a large bowl, gradually mix the plants with warm water at approximately 50–70°C until the mixture reaches a yogurt-like consistency. Apply to clean, dry, thoroughly detangled hair from roots to ends and leave on for 60–90 minutes depending on the desired color intensity before washing only with water. To retain the color, it is important to wait at least 24 hours before washing the hair with a mild shampoo.",
        precautions:
          "For external use only. Avoid direct contact with eyes. This product does not lighten the hair as it contains no oxidizing agents or chemical bleaching agents. A skin sensitivity test is recommended to ensure there are no allergies to this product. Results may vary from one hair type to another depending on the base color and texture. Store in a cool, dry place protected from sunlight.",
        img: "/images/products/terra_santa_planta_marron_dorado.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        ...
        type: "Ayurvedic Blend",
        price: 28,
        desc: "Natural medium brown shade. Ideal for blending tones and covering first grey hairs with a glossy effect.",
        ingredients:
          "Indigofera Tinctoria, Lawsonia Inermis, Emblica Officinalis (Amla).",
        usage:
          "Mix with water at 50°C. Apply immediately. Processing time: 60–90 minutes.",
        precautions:
          "Do not use shampoo for the following 24 hours to allow the color to set.",
        img: "/images/products/terra_santa_planta_castanya.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "planta-castana-oscuro",
        name: "Dark Chestnut Plant",
        category: "Vegetal Coloring",
        type: "Ayurvedic Blend",
        price: 28,
        desc: "Depth and coverage for brown hair. Adds body and darkens lighter shades.",
        ingredients:
          "Indigofera Tinctoria Leaf Powder, Lawsonia Inermis Powder, Emblica Officinalis Fruit Powder.",
        usage:
          "In a large bowl, gradually mix the plants with warm water at approximately 50–70°C until the mixture reaches a yogurt-like consistency. Apply to clean, dry, thoroughly detangled hair from roots to ends and leave on for 60–90 minutes depending on the desired color intensity before washing only with water. To retain the color, wait at least 24 hours before washing the hair with a mild shampoo.",
        precautions:
          "For external use only. Avoid direct contact with eyes. This product does not lighten the hair as it contains no oxidizing agents or chemical bleaching agents. A skin sensitivity test is recommended to ensure there are no allergies to this product. Results may vary depending on the base color and texture of each hair type. Store in a cool, dry place protected from sunlight.",
        img: "/images/products/terra_santa_planta_castaña_oscuro.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        ...
        type: "100% Organic",
        price: 28,
        desc: "Pure plant pigment to achieve deep dark shades and blue-black tones when combined with other plants.",
        ingredients: "Indigofera Tinctoria Leaf Powder (Pure Indigo).",
        usage:
          "In a large bowl, gradually mix the plants with warm water at approximately 50–70°C until the mixture reaches a yogurt-like consistency. Apply to clean, dry, thoroughly detangled hair from roots to ends and leave on for 60–90 minutes depending on the desired color intensity before washing only with water. To retain the color, wait at least 12 hours before washing the hair with a mild shampoo. Use alone or as a two-step process (first henna, then indigo) for grey hair coverage in black tones.",
        precautions:
          "For external use only. Avoid direct contact with eyes. This product does not lighten the hair as it contains no oxidizing agents or chemical bleaching agents. A skin sensitivity test is recommended to ensure there are no allergies to this product. Results may vary depending on the base color and texture of each hair type. Store in a cool, dry place protected from sunlight.",
        img: "/images/products/terra_santa_planta_indigo.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      },
      {
        ...
        ingredients:
          "Vigna Radiata Seed Powder, Ziziphus Jujuba Leaf Powder, Emblica Officinalis Fruit Powder, Azadirachta Indica Leaf Powder, Rubia Cordifolia Root Powder, Glycyrrhiza Glabra Root Powder.",
        usage:
          "Mix with warm water until a creamy paste is formed. Optionally, add 2-3 teaspoons of an organic hair oil to provide additional hydration. Apply to clean and thoroughly detangled hair, from roots to ends, and leave on for 30–45 minutes before rinsing with water only.",
        precautions:
          "For external use only. Avoid direct contact with eyes. This product does not lighten the hair as it contains no oxidizing agents or chemical bleaching agents. A skin sensitivity test is recommended to ensure there are no allergies to this product. Results may vary from one hair type to another depending on the base color and texture of each hair. Store in a cool, dry place protected from sunlight.",
        img: "/images/products/terra_santa_tratamiento_capilar_green_detox.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
        isNew: true,
      },
      ...
      },
      {
        ...
        ingredients: "Astragalus Gummifer Gum Powder.",
        usage:
          "Mix 5 g of product with approximately 200 ml of warm water until a creamy paste is formed. Apply to clean, wet hair and distribute evenly. Dry with a hairdryer or allow to air dry.",
        precautions:
          "For external use only. Avoid direct contact with eyes. This product does not lighten the hair as it contains no oxidizing agents or chemical bleaching agents. A skin sensitivity test is recommended to ensure there are no allergies to this product. Results may vary from one hair type to another depending on the base color and texture of each hair. Store in a cool, dry place protected from sunlight.",
        img: "/images/products/terra_santa_tratamiento_capilar_magical_green_curly.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      {
        id: "shampoo-gratitud",
        name: "Gratitude Shampoo",
        category: "Hair Hygiene",
        type: "Frequent Use",
        price: 33.5,
        desc: "Natural and organic shampoo for all hair types. Gently cleanses while hydrating and helping to balance the scalp.",
        ingredients:
          "Aqua, Decyl Glucoside, Lauryl Glucoside, Disodium Cocoamphoacetate, Lavandula Hybrida Grosso Herb Oil*, Argania Spinosa Kernel Oil*, Erythritol, Inulin, Aloe Barbadensis Leaf Juice*, Sodium Cocoyl Hydrolyzed Wheat Protein, Glycerin, Xanthan Gum, Benzyl Alcohol, Coco-Glucoside, Glyceryl Oleate, Potassium Sorbate, Sodium Benzoate, Panthenol, Citric Acid, Tocopherol, Alcohol, Limonene**, Linalool**, Malus Pumila Bach Flower Extract, Scleranthus Annus Bach Flower Extract, Juglans Regia Bach Flower Extract. (*Organic / **From pure essential oils)",
        usage:
          "Gently massage onto wet hair. Leave for a few moments and rinse. If necessary, repeat a second application using a smaller amount.",
        precautions:
      ...
      {
        id: "shampoo-abundancia",
        name: "Abundance Shampoo",
        category: "Hair Hygiene",
        type: "Volume and Strength",
        price: 33.5,
        desc: "Natural and organic shampoo to strengthen and care for the hair. Provides strength, nourishment, and helps improve the appearance of hair density.",
        ingredients:
          "Aqua, Decyl Glucoside, Lauryl Glucoside, Disodium Cocoamphoacetate, Limonene, Citrus Sinensis Peel Oil Expressed*, Glycerin, Erythritol, Inulin, Helianthus Annuus Seed Oil, Sodium Cocoyl Hydrolyzed Wheat Protein, Alcohol, Xanthan Gum, Benzyl Alcohol, Coco-Glucoside, Emblica Officinalis Fruit Powder*, Glyceryl Oleate, Citrus Paradisii Peel Oil, Eucalyptus Globulus Leaf Oil*, Panthenol, Potassium Sorbate, Sodium Benzoate, Equisetum Arvense Extract*, Lepidium Meyenii Root Extract, Rosmarinus Officinalis Extract*, Salvia Officinalis Leaf Extract*, Urtica Dioica Leaf Extract*, Citric Acid, Citral, Citronellol, Linalool, Tocopherol, Carpinus Betulus Flower Extract, Larix Decidua Flower Extract, Malus Sylvestris Flower Extract, Olea Europaea Flower Extract. (*Organic / ^From pure essential oils)",
        usage:
          "Gently massage onto wet hair. Leave for a few moments and rinse. If necessary, repeat a second application using a smaller amount.",
        precautions:
          "For external use only. Do not ingest. Avoid contact with eyes.",
      ...
      },
      {
        ...
        usage:
          "Apply to wet hair, gently massage the scalp and hair. Rinse thoroughly with plenty of water.",
      ...
      },
      {
        ...
        category: "Hydration and Body",
        type: "Leave-In",
        price: 34.5,
        desc: "Natural and organic leave-in conditioner that hydrates, makes combing easier, and helps minimize frizz.",
        ingredients:
          "Aqua, Urtica Dioica Leaf Extract*, Helianthus Annuus Seed Oil, Cocos Nucifera Oil*, Inulin, Glycerin, Citrus Sinensis Peel Oil Expressed*, Lavandula Hybrida Grosso Herb Oil*, Limonene^, Behenamidopropyldimethylamine, Benzyl Alcohol, Emblica Officinalis Fruit Powder, Potassium Sorbate, Sodium Benzoate, Litsea Cubeba Fruit Oil*, Biosaccharide Gum-1, Porphyra Umbilicalis Extract, Sodium Levulinate, Caesalpinia Spinosa Gum, Glyceryl Caprylate, Sodium Anisate, Citral^, Citronellol^, Linalool^, Farnesol^, Geraniol^, Alcohol, Leuconostoc/Radish Root Ferment Filtrate, Carpinus Betulus Flower Extract, Ilex Aquifolium Flower Extract, Olea Europaea Flower Extract, Scleranthus Annuus Flower Extract, Gentiana Amarella Flower Extract, Juglans Regia Flower Extract, Prunus Cerasifera Flower Extract. (*Organic / ^From pure essential oils)",
        usage:
          "On freshly washed damp hair, apply the conditioner with the spray all over the hair and distribute with hands to cover the entire surface. You can dry the hair afterwards if desired.",
        precautions:
          "For external use only. Do not ingest. Avoid contact with eyes.",
        img: "/images/products/terra_santa_acondicionador_sin_aclarado.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        ...
        type: "Nutrition and Repair",
        price: 35.5,
        desc: "Blend of virgin and organic vegetable oils that nourishes, adds shine, and helps strengthen the hair from roots to ends. Ideal for dry, frizzy hair, and curls.",
        ingredients:
          "Cocos Nucifera Oil*, Ricinus Communis Seed Oil*, Helianthus Annuus Seed Oil*, Sesamum Indicum Seed Oil*, Argania Spinosa Kernel Oil*, Emblica Officinalis Powder, Rosmarinus Officinalis Leaf Oil*, Lavandula Hybrida Grosso Herb Oil*, Linalool^, Eucalyptus Globulus Leaf/Stem Oil*, Mentha Arvensis Herb Oil*, Thymus Zygis Herb Oil*, Cupressus Sempervirens Leaf/Nut/Stem Oil, Limonene^, Geraniol^, Coumarin^, Eugenol^, Citral^, Alcohol, Olea Europaea Flower Extract, Centaurium Umbellatum Flower Extract, Carpinus Betulus Flower Extract, Scleranthus Annus Flower Extract. (*Organic / ^From pure essential oils)",
        usage:
          "Dry or split ends: apply 2 or 3 drops to the ends, massage, and leave on for about 20 minutes. It can be washed afterwards or not. Dry or frizzy hair: apply 3-4 drops to the hands, rub to warm the serum, and gently apply all over the hair up to twice a day. Dry scalp and hair loss: massage a few drops onto the scalp with circular motions, leave on for at least 30 minutes or as many hours as desired, and wash afterwards. Curls: apply a few drops to the hands, rub, and press the curls from the bottom up to define them gently. Do not rinse.",
        precautions:
          "For external use only. Do not ingest. Avoid contact with eyes.",
        img: "/images/products/terra_santa_serum_en_aceite.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      {
        id: "locion-capilar-aloe",
        name: "Aloe Hair Lotion",
        category: "Hydration and Body",
        type: "Calming",
        price: 23.5,
        desc: "Hair lotion for all hair types. Strengthens, hydrates, and helps eliminate impurities from the hair and scalp.",
        ingredients:
          "Aloe Barbadensis Leaf Juice*, Cannabis Sativa Seed Oil*, Benzyl Alcohol, Simmondsia Chinesis Seed Oil*, Xanthan Gum, Rosmarinus Officinalis Leaf Oil*, Thymus Zygis Oil*, Ascorbic Acid, Dehydroacetic Acid, Sodium Metabisulfite, Limonene**, Linalool**, Pinene*, Beta Caryophyllene**, Camphor**, Alfa Terpineol*. (*Certified organic ingredient / **Natural ingredient contained in essential oils)",
        usage:
          "Apply a small amount to the palm of the hand, rub into both hands, and apply to the scalp with a gentle, penetrating massage. More can be added and applied through the rest of the hair. Leave on for about twenty minutes, then wash.",
        precautions:
          "For all hair types. Avoid contact with eyes. External use.",
        img: "/images/products/terra_santa_locion_capilar_aloe.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "locion-gel-aloe-vera-puro",
        name: "Pure Aloe Vera Gel Lotion",
        category: "Hydration and Body",
        type: "Multipurpose",
        price: 16.5,
        desc: "Aloe Vera lotion made with fresh Aloe leaves from Almería. Hydrating and regenerating, it helps increase skin elasticity and firmness.",
        ingredients:
          "Aloe Barbadensis Leaf Juice*, Xanthan Gum, Benzyl Alcohol, Ascorbic Acid, Dehydroacetic Acid, Sodium Metabisulfite. (*Certified organic ingredient)",
        usage: "Apply to dry skin with a gentle massage.",
        precautions:
          "Once opened, keep in a cool, dark place. Suitable for all skin types.",
        img: "/images/products/terra_santa_locion_aloe_vera_puro.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "leche-corporal",
        name: "Regenerating Body Milk",
        category: "Hydration and Body",
        type: "Body Milk",
        price: 27.87,
        desc: "Regenerating body milk with Aloe from Almería, Rosehip, and organic vegetable oils. Hydrates, nourishes, and helps care for damaged areas of the skin.",
        ingredients:
          "Aloe Barbadensis Leaf Juice*, Rosa Canina Seed Oil*, Lavandula Angustifolia Flower Water*, Glycine Max Oil*, Cannabis Sativa Seed Oil*, Glyceryl Stearate Citrate, Benzyl Alcohol, Lavandula Angustifolia Oil*, Xanthan Gum, Ascorbic Acid, Dehydroacetic Acid, Linalyl Acetate**, Linalool**, Terpineol**, Geraniol**, Limonene**. (*Certified organic ingredient / **Natural ingredient contained in essential oils)",
        usage:
          "Apply to dry skin with a gentle massage. Daily use as a body moisturizer.",
        precautions:
          "Once opened, keep in a cool, dark place. Suitable for damaged skin areas. Can be used as aftersun and after hair removal.",
        img: "/images/products/terra_santa_leche_corporal_regeneradora.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
    ],
  ...
  ca: {
    ...
    hero: {
      title: "Terra Santa Eulalia",
      subtitle: "Des de les Índies, a casa teva",
      cta: "Descobreix els Nostres Productes",
    },
    domestic: {
      title: "Productes Naturals",
      subtitle: "L'alquímia de la terra a casa teva",
    ...
    cards: {
      ...
      therapyTitle: "TERÀPIA ORGÀNICA\NCAPIL·LAR",
    ...
    treatmentsPage: {
      ...
      extrasSubtitle: "Express Express",
      hairRituals: {
        title: "Rituals Orgànics Capil·lars",
        desc: "Recupera la força i salut del teu cabell amb fangs i plantes.",
        list: [
          {
            id: "ritual-detox",
            title: "Ritual Detox",
            desc: "Aquest tractament neteja en profunditat el cuir cabellut gràcies a la barreja de plantes medicinals desintoxicants. Indicat de manera especial per a problemes de dermatitis seborreica, descamació, caspa i excés de greix capil·lar.",
            extra:
              "Gaudeix d'un relaxant massatge facial o de peus durant el temps d'exposició, tu tries.",
            duration: "50 min",
            price: "85€",
          },
          {
            ...
            desc: "L'objectiu d'aquest ritual és donar al teu cabell la força i vitalitat que necessita. Si sents que el teu cabell està feble, gairebé no té cos i li falta vida, sense dubte aquest és el teu ritual. Sentir l'aroma de les plantes aiurvèdiques al teu cabell et farà connectar amb la pau i l'harmonia que necessites.",
            extra: "Inclou un relaxant massatge facial o de peus, tu tries.",
            duration: "60 min",
            price: "95€",
          },
          {
            id: "ritual-rizos",
            title: "Ritual Rínxols Perfectes",
            desc: "Trobes a faltar la flexibilitat i l'estructura dels teus rínxols? La barreja d'herbes que apliquem en aquest ritual ajudarà el teu cabell a recuperar l'estructura perduda del rínxol. Rínxols sense vida? Ja no, gràcies a l'acció de la nostra barreja de plantes.",
            extra:
              "Gaudeix d'un relaxant massatge facial o de peus durant el temps d'exposició, tu tries.",
            duration: "50 min",
            price: "85€",
    ...
    capillaryPage: {
      ...
      title: "Teràpia Orgànica Capil·lar",
      ...
      vipServicesDesc: "Tecnologia avançada meets botànica:",
      vipServices: [
        {
      ...
      ritualsTitle: "Rituals Orgànics Capil·lars",
      ritualsDesc:
    ...
    philosophy: {
      ...
      manifesto:
        "No creiem en la bellesa fabricada. Creiem en la bellesa revelada. Terra Santa Eulalia no és una marca, és un retorn a la memòria de la terra.",
      ...
      laiaBio: {
        ...
        inspiration:
          "Em va inspirar observar com moltes persones busquen veure's bé, però també necessiten sentir-se en pau, recuperar la seva energia i reconnectar amb elles mateixes. Vaig comprendre que la bellesa vertadera apareix quan una persona se sent cuidada, escoltada i en harmonia amb la seva essència.",
        nature:
    ...
    productsList: [
      {
        id: "planta-fortalecedora",
        name: "Planta Enfortidora i Brillant",
        category: "Tractament en Pols",
        type: "Cassia Obovata",
        price: 28,
        desc: "Coneguda com a 'Henna Neutra'. No tenyeix, però aporta brillantor i ajuda a enfortir la fibra capil·lar.",
        ingredients: "Cassia Obovata Leaf Powder.",
        usage:
          "Barrejar 2 o 3 cullerades de la planta amb aigua tèbia fins a formar una pasta cremosa. Opcionalment, afegir 3-4 culleradetes d'un oli vegetal premsat en fred per nodrir el cabell amb més vitamines. Deixar-la refredar i aplicar-la des del cuir cabellut fins a les puntes del cabell. Es recomana deixar actuar aproximadament 1 hora abans de rentar amb un xampú suau.",
        precautions:
          "Només per a ús extern. Evitar el contacte directe amb els ulls. El producte no aclareix el cabell ja que no conté oxidants ni químics blanquejadors. Es recomana realitzar una prova sobre la pell per assegurar-se que no existeixen al·lèrgies a aquest producte. El resultat pot variar d'un cabell a un altre depenent del color base i la textura de cada cabell. Guardar en un lloc sec i fresc, protegit de la llum solar.",
        img: "/images/products/terra_santa_planta_fortalecedora_brillante.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "planta-rubio-luminoso",
        name: "Planta Ros Daurat Lluminós",
        category: "Coloració Vegetal",
        type: "Barreja Ayurvèdica",
        price: 28,
        desc: "Barreja de plantes per activar reflexos daurats en cabells clars i aportar tractament.",
        ingredients:
          "Cassia Italica Leaf Powder, Lawsonia Inermis Powder, Chamomilla Recutita Flower Powder, Curcuma Longa Root Powder.",
        usage:
          "En un bol gran, barrejar la pols gradualment amb aigua tèbia (aproximadament a 30 °C) fins obtenir una consistència similar a la del iogurt. Aplicar immediatament sobre el cabell net, sec i perfectament desenredat, des de l'arrel fins a les puntes. Deixar actuar entre 20 i 40 minuts, segons la intensitat de color desitjada. A continuació, aclarir i rentar amb un xampú suau.",
        precautions:
          "Només per a ús extern. Evitar el contacte directe amb els ulls. Aquest producte no aclareix el cabell, ja que no conté oxidants ni agents blanquejadors químics. Es recomana realitzar una prova de sensibilitat sobre la pell abans del seu ús per descartar possibles reaccions al·lèrgiques. El resultat pot variar segons el color base i la textura de cada cabell. Conservar en un lloc fresc i sec, protegit de la llum solar.",
        img: "/images/products/terra_santa_planta_rubio_luminoso.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        ...
        type: "Barreja Ayurvèdica",
        price: 28,
        desc: "Matís càlid i dolç per a cabells rossos o castanys clars que busquen calidesa.",
        ingredients:
          "Cassia Italica Leaf Powder, Lawsonia Inermis Powder, Indigofera Tinctoria Leaf Powder, Aloe Barbadensis Leaf Powder, Emblica Officinalis Fruit Powder, Ziziphus Jujuba Powder.",
        usage:
          "En un bol gran barrejar les plantes amb aigua tèbia a uns 30ºC poc a poc fins que la barreja tingui la consistència del iogurt. Aplicar immediatament sobre el cabell net, sec i ben desenredat, des de l'arrel fins a la punta del cabell, i esperar entre 40–50 minuts (depenent de la intensitat de color que es desitgi) abans de rentar amb aigua.",
        precautions:
          "Només per a ús extern. Evitar el contacte directe amb els ulls. El producte no aclareix el cabell ja que no conté oxidants ni químics blanquejadors. Es recomana realitzar una prova sobre la pell per assegurar-se que no existeixen al·lèrgies a aquest producte. El resultat pot variar d'un cabell a un altre depenent del color base i la textura de cada cabell. Guardar en un lloc sec i fresc, protegit de la llum solar.",
        img: "/images/products/terra_santa_planta_rubio_miel.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      {
        id: "planta-puro-cobre",
        name: "Planta Pur Coure",
        category: "Coloració Vegetal",
        type: "100% Orgànic",
        price: 28,
        desc: "Henna pura d'alta qualitat. Aporta un color rogenc intens, força i una brillantor espectacular.",
        ingredients: "Lawsonia Inermis Leaf Powder.",
        usage:
          "En un bol gran barrejar les plantes amb aigua tèbia a uns 50–70ºC poc a poc fins que la barreja tingui la consistència del iogurt. Aplicar sobre el cabell net, sec i ben desenredat, des de l'arrel fins a la punta del cabell, i esperar entre 60–90 minuts (depenent de la intensitat de color que es desitgi) abans de rentar només amb un xampú suau.",
        precautions:
          "Només per a ús extern. Evitar el contacte directe amb els ulls. El producte no aclareix el cabell ja que no conté oxidants ni químics blanquejadors. Es recomana realitzar una prova sobre la pell per assegurar-se que no existeixen al·lèrgies a aquest producte. El resultat pot variar d'un cabell a un altre depenent del color base i la textura de cada cabell. Guardar en un lloc sec i fresc, protegit de la llum solar.",
        img: "/images/products/terra_santa_planta_puro_cobre.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      {
        id: "planta-marron-dorado",
        name: "Planta Marró Daurat",
        category: "Coloració Vegetal",
        type: "Barreja Ayurvèdica",
        price: 28,
        desc: "Barreja vegetal per aconseguir tons marró daurat càlids i naturals. Aporta matisos de color, brillantor i cos al cabell.",
        ingredients:
          "Lawsonia Intermis Powder, Indigofera Tinctoria Leaf Powder, Juglans Regia Shell Powder, Emblica Officinalis Fruit Powder, Ziziphus Jujuba Powder, Aloe Barbadensis Leaf Powder, Curcuma Longa Root Powder.",
        usage:
          "En un bol gran barrejar les plantes amb aigua tèbia a uns 50–70ºC poc a poc fins que la barreja tingui la consistència del iogurt. Aplicar sobre el cabell net, sec i ben desenredat, des de l'arrel fins a la punta del cabell, i esperar entre 60–90 minuts (depenent de la intensitat de color que es desitgi) abans de rentar només amb aigua. Per retenir el color, és important esperar un mínim de 24 hores abans de rentar el cabell amb un xampú suau.",
        precautions:
          "Només per a ús extern. Evitar el contacte directe amb els ulls. El producte no aclareix el cabell ja que no conté oxidants ni químics blanquejadors. Es recomana realitzar una prova sobre la pell per assegurar-se que no existeixen al·lèrgies a aquest producte. El resultat pot variar d'un cabell a un altre depenent del color base i la textura de cada cabell. Guardar en un lloc sec i fresc, protegit de la llum solar.",
        img: "/images/products/terra_santa_planta_marron_dorado.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      {
        id: "planta-castana",
        name: "Planta Castanya",
        category: "Coloració Vegetal",
        type: "Barreja Ayurvèdica",
        price: 28,
        desc: "To marró mitjà natural. Ideal per unificar tons i cobrir primeres canes amb efecte vernís.",
        ingredients:
          "Indigofera Tinctoria, Lawsonia Inermis, Emblica Officinalis (Amla).",
        usage:
          "Barrejar amb aigua a 50ºC. Aplicar immediatament. Temps: 60-90 min.",
        precautions:
          "No usar xampú les següents 24h perquè el color s'assenti.",
        img: "/images/products/terra_santa_planta_castanya.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "planta-castana-oscuro",
        name: "Planta Castany Fosc",
        category: "Coloració Vegetal",
        type: "Barreja Ayurvèdica",
        price: 28,
        desc: "Profunditat i cobertura per a cabells castanys. Aporta cos i enfosqueix tons clars.",
        ingredients:
          "Indigofera Tinctoria Leaf Powder, Lawsonia Inermis Powder, Emblica Officinalis Fruit Powder.",
        usage:
          "En un bol gran barrejar les plantes amb aigua tèbia a uns 50–70ºC poc a poc fins que la barreja tingui la consistència del iogurt. Aplicar sobre el cabell net, sec i ben desenredat, des de l'arrel fins a la punta del cabell, i esperar entre 60–90 minuts (depenent de la intensitat de color que es desitgi) abans de rentar només amb aigua. Per retenir el color, és important esperar un mínim de 24 hores abans de rentar el cabell amb un xampú suau.",
      ...
      },
      {
        ...
        type: "100% Orgànic",
        price: 28,
        desc: "Pigment pur vegetal per aconseguir tons foscos profunds i negres blavosos en combinació amb altres plantes.",
        ingredients: "Indigofera Tinctoria Leaf Powder (Índigo puro).",
        usage:
          "En un bol gran barrejar les plantes amb aigua tèbia a uns 50 – 70ºC poc a poc fins que la barreja tingui la consistència del iogurt. Aplicar sobre el cabell net, sec i ben desenredat, des de l'arrel fins a la punta del cabell, i esperar entre 60 – 90 minuts (depenent de la intensitat de color que es desitgi) abans de rentar només amb aigua. Per retenir el color, és important esperar un mínim de 12 hores abans de rentar el cabell amb un xampú suau. Barrejar amb aigua a 50ºC. Usar sol o en dos passos (primer henna, després índigo) per cobertura de canes en negre. Temps: 60-90 min.",
        precautions:
          "Només per a ús extern. Evitar el contacte directe amb els ulls. El producte no aclareix el cabell ja que no conté oxidants ni químics blanquejadors. Es recomana realitzar una prova sobre la pell per assegurar-se que no existeixen al·lèrgies a aquest producte. El resultat pot variar d'un cabell a un altre depenent del color base i la textura de cada cabell. Guardar en un lloc sec i fresc, protegit de la llum solar.",
        img: "/images/products/terra_santa_planta_indigo.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      },
      {
        ...
        ingredients:
          "Vigna Radiata Seed Powder, Ziziphus Jujuba Leaf Powder, Emblica Officinalis Fruit Powder, Azadirachta Indica Leaf Powder, Rubia Cordifolia Root Powder, Glycyrrhiza Glabra Root Powder.",
        usage:
          "Barrejar amb aigua tèbia fins a formar una pasta cremosa. Opcionalment, afegir 2-3 culleradetes d'un oli capil·lar orgànic per aportar hidratació al cabell. Aplicar sobre el cabell net i ben desenredat, des de l'arrel fins a la punta del cabell, i esperar entre 30–45 minuts abans de rentar només amb aigua.",
        precautions:
          "Només per a ús extern. Evitar el contacte directe amb els ulls. El producte no aclareix el cabell ja que no conté oxidants ni químics blanquejadors. Es recomana realitzar una prova sobre la pell per assegurar-se que no existeixen al·lèrgies a aquest producte. El resultat pot variar d'un cabell a un altre depenent del color base i la textura de cada cabell. Guardar en un lloc sec i fresc, protegit de la llum solar.",
        img: "/images/products/terra_santa_tratamiento_capilar_green_detox.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      },
      {
        ...
        ingredients: "Astragalus Gummifer Gum Powder.",
        usage:
          "Barrejar 5 gr de producte amb uns 200 ml d'aigua tèbia fins a formar una pasta cremosa. Aplicar sobre el cabell net i mullat, i distribuir bé. Assecar amb assecador o a l'aire.",
        precautions:
          "Només per a ús extern. Evitar el contacte directe amb els ulls. El producte no aclareix el cabell ja que no conté oxidants ni químics blanquejadors. Es recomana realitzar una prova sobre la pell per assegurar-se que no existeixen al·lèrgies a aquest producte. El resultat pot variar d'un cabell a un altre depenent del color base i la textura de cada cabell. Guardar en un lloc sec i fresc, protegit de la llum solar.",
        img: "/images/products/terra_santa_tratamiento_capilar_magical_green_curly.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      ...
      },
      {
        ...
        type: "Ús Freqüent",
        price: 33.5,
        desc: "Xampú natural i orgànic per a tot tipus de cabell. Neteja suaument mentre hidrata i ajuda a equilibrar el cuir cabellut.",
        ingredients:
          "Aqua, Decyl Glucoside, Lauryl Glucoside, Disodium Cocoamphoacetate, Lavandula Hybrida Grosso Herb Oil*, Argania Spinosa Kernel Oil*, Erythritol, Inulin, Aloe Barbadensis Leaf Juice*, Sodium Cocoyl Hydrolyzed Wheat Protein, Glycerin, Xanthan Gum, Benzyl Alcohol, Coco-Glucoside, Glyceryl Oleate, Potassium Sorbate, Sodium Benzoate, Panthenol, Citric Acid, Tocopherol, Alcohol, Limonene**, Linalool**, Malus Pumila Bach Flower Extract, Scleranthus Annus Bach Flower Extract, Juglans Regia Bach Flower Extract. (*Orgànic / **D'olis essencials purs)",
        usage:
          "Fer un massatge suau sobre el cabell humit. Deixar actuar uns instants i aclarir. Si és necessari, repetir una segona aplicació amb menys quantitat.",
        precautions: "Ús extern. No ingerir. Evitar el contacte amb els ulls.",
        img: "/images/products/terra_santa_shampo_gratitud_cabello_todo_tipo.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "shampoo-abundancia",
        name: "Xampú Abundància",
        category: "Higiene Capil·lar",
        type: "Volum i Força",
        price: 33.5,
        desc: "Xampú natural i orgànic per enfortir i cuidar el cabell. Aporta força, nutrició i ajuda a millorar l'aparença de densitat capil·lar.",
        ingredients:
          "Aqua, Decyl Glucoside, Lauryl Glucoside, Disodium Cocoamphoacetate, Limonene, Citrus Sinensis Peel Oil Expressed*, Glycerin, Erythritol, Inulin, Helianthus Annuus Seed Oil, Sodium Cocoyl Hydrolyzed Wheat Protein, Alcohol, Xanthan Gum, Benzyl Alcohol, Coco-Glucoside, Emblica Officinalis Fruit Powder*, Glyceryl Oleate, Citrus Paradisii Peel Oil, Eucalyptus Globulus Leaf Oil*, Panthenol, Potassium Sorbate, Sodium Benzoate, Equisetum Arvense Extract*, Lepidium Meyenii Root Extract, Rosmarinus Officinalis Extract*, Salvia Officinalis Leaf Extract*, Urtica Dioica Leaf Extract*, Citric Acid, Citral, Citronellol, Linalool, Tocopherol, Carpinus Betulus Flower Extract, Larix Decidua Flower Extract, Malus Sylvestris Flower Extract, Olea Europaea Flower Extract. (*Orgànic / ^D'olis essencials purs)",
        usage:
          "Fer un massatge suau sobre el cabell humit. Deixar actuar uns instants i aclarir. Si és necessari, repetir una segona aplicació amb menys quantitat.",
        precautions: "Ús extern. No ingerir. Evitar el contacte amb els ulls.",
        img: "/images/products/terra_santa_shampoo_abundancia_todo_tipo_cabello.PNG",
      ...
      },
      {
        ...
        usage:
          "Aplicar sobre el cabell humit, fer un massatge suau al cuir cabellut i el cabell. Aclarir amb abundant aigua.",
        precautions: "Ús extern. Evitar el contacte amb els ulls.",
        img: "/images/products/terra_santa_shampoo_fidelis.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "acondicionador-sin-aclarado",
        name: "Condicionador sense esbandir",
        category: "Hidratació i Cos",
        type: "Leave-In",
        price: 34.5,
        desc: "Condicionador natural i orgànic sense esbandir que hidrata, facilita la pentinada i ajuda a minimitzar l'encrespament.",
        ingredients:
          "Aqua, Urtica Dioica Leaf Extract*, Helianthus Annuus Seed Oil, Cocos Nucifera Oil*, Inulin, Glycerin, Citrus Sinensis Peel Oil Expressed*, Lavandula Hybrida Grosso Herb Oil*, Limonene^, Behenamidopropyldimethylamine, Benzyl Alcohol, Emblica Officinalis Fruit Powder, Potassium Sorbate, Sodium Benzoate, Litsea Cubeba Fruit Oil*, Biosaccharide Gum-1, Porphyra Umbilicalis Extract, Sodium Levulinate, Caesalpinia Spinosa Gum, Glyceryl Caprylate, Sodium Anisate, Citral^, Citronellol^, Linalool^, Farnesol^, Geraniol^, Alcohol, Leuconostoc/Radish Root Ferment Filtrate, Carpinus Betulus Flower Extract, Ilex Aquifolium Flower Extract, Olea Europaea Flower Extract, Scleranthus Annuus Flower Extract, Gentiana Amarella Flower Extract, Juglans Regia Flower Extract, Prunus Cerasifera Flower Extract. (*Orgànic / ^D'olis essencials purs)",
        usage:
          "Sobre el cabell humit acabat de rentar, aplicar el condicionador amb l'esprai per tot el cabell i distribuir amb les mans per cobrir tota la superfície. Es pot assecar el cabell després si es desitja.",
        precautions: "Ús extern. No ingerir. Evitar el contacte amb els ulls.",
        img: "/images/products/terra_santa_acondicionador_sin_aclarado.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "serum-en-aceite",
        name: "Sèrum en Oli",
        category: "Tractament Capil·lar",
        type: "Nutrició i Reparació",
        price: 35.5,
        desc: "Barreja d'olis vegetals verges i orgànics que nodreix, aporta brillantor i ajuda a enfortir el cabell des de l'arrel fins a les puntes. Ideal per a cabells secs, encrespats i rissos.",
        ingredients:
          "Cocos Nucifera Oil*, Ricinus Communis Seed Oil*, Helianthus Annuus Seed Oil*, Sesamum Indicum Seed Oil*, Argania Spinosa Kernel Oil*, Emblica Officinalis Powder, Rosmarinus Officinalis Leaf Oil*, Lavandula Hybrida Grosso Herb Oil*, Linalool^, Eucalyptus Globulus Leaf/Stem Oil*, Mentha Arvensis Herb Oil*, Thymus Zygis Herb Oil*, Cupressus Sempervirens Leaf/Nut/Stem Oil, Limonene^, Geraniol^, Coumarin^, Eugenol^, Citral^, Alcohol, Olea Europaea Flower Extract, Centaurium Umbellatum Flower Extract, Carpinus Betulus Flower Extract, Scleranthus Annus Flower Extract. (*Orgànic / ^D'olis essencials purs)",
        usage:
          "Puntes seques o obertes: aplicar 2 o 3 gotes a les puntes, fer un massatge i deixar actuar uns 20 minuts. Es pot rentar després o no. Cabell sec o encrespat: aplicar 3-4 gotes a les mans, fregar per escalfar el sèrum i aplicar suaument sobre tot el cabell fins a 2 vegades al dia. Cuir cabellut sec i caiguda capil·lar: fer un massatge amb unes gotes sobre el cuir cabellut amb moviments circulars, deixar actuar mínim 30 minuts o tantes hores com es desitgi i rentar després. Rissos: aplicar unes gotes a les mans, fregar i pressionar els rissos de baix cap a dalt per definir-los suaument. No esbandir.",
        precautions: "Ús extern. No ingerir. Evitar el contacte amb els ulls.",
        img: "/images/products/terra_santa_serum_en_aceite.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "locion-capilar-aloe",
        name: "Loció Capil·lar Aloe",
        category: "Hidratació i Cos",
        type: "Calmant",
        price: 23.5,
        desc: "Loció capil·lar per a tot tipus de cabells. Enforteix, hidrata i ajuda a eliminar impureses del cabell i cuir cabellut.",
        ingredients:
          "Aloe Barbadensis Leaf Juice*, Cannabis Sativa Seed Oil*, Benzyl Alcohol, Simmondsia Chinesis Seed Oil*, Xanthan Gum, Rosmarinus Officinalis Leaf Oil*, Thymus Zygis Oil*, Ascorbic Acid, Dehydroacetic Acid, Sodium Metabisulfite, Limonene**, Linalool**, Pinene*, Beta Caryophyllene**, Camphor**, Alfa Terpineol*. (*Ingredient ecològic certificat / **Ingredient natural contingut en els olis essencials)",
        usage:
          "Aplicar una petita quantitat al palmell de la mà, fregar en ambdues mans i aplicar al cuir cabellut, fent un suau i penetrant massatge. Es pot afegir més quantitat i aplicar per la resta del cabell. Deixar actuar uns vint minuts i després rentar.",
        precautions:
          "Per a tot tipus de cabells. Evitar el contacte amb els ulls. Ús extern.",
        img: "/images/products/terra_santa_locion_capilar_aloe.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "locion-gel-aloe-vera-puro",
        name: "Loció Gel d'Aloe Vera Pur",
        category: "Hidratació i Cos",
        type: "Multiusos",
        price: 16.5,
        desc: "Loció d'Aloe Vera elaborada amb fulles fresques d'Aloe d'Almeria. Hidratant i regeneradora, ajuda a augmentar l'elasticitat i fermesa de la pell.",
        ingredients:
          "Aloe Barbadensis Leaf Juice*, Xanthan Gum, Benzyl Alcohol, Ascorbic Acid, Dehydroacetic Acid, Sodium Metabisulfite. (*Ingredient ecològic certificat)",
        usage: "Aplicar sobre la pell seca fent un suau massatge.",
        precautions:
          "Un cop obert mantenir en un lloc fresc i fosc. Indicat per a tot tipus de pells.",
        img: "/images/products/terra_santa_locion_aloe_vera_puro.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
      {
        id: "leche-corporal",
        name: "Llet Corporal Regeneradora",
        category: "Hidratació i Cos",
        type: "Body Milk",
        price: 27.87,
        desc: "Llet corporal regeneradora amb Aloe d'Almeria, Rosa Mosqueta i olis vegetals ecològics. Hidrata, nodreix i ajuda a cuidar les zones danyades de la pell.",
        ingredients:
          "Aloe Barbadensis Leaf Juice*, Rosa Canina Seed Oil*, Lavandula Angustifolia Flower Water*, Glycine Max Oil*, Cannabis Sativa Seed Oil*, Glyceryl Stearate Citrate, Benzyl Alcohol, Lavandula Angustifolia Oil*, Xanthan Gum, Ascorbic Acid, Dehydroacetic Acid, Linalyl Acetate**, Linalool**, Terpineol**, Geraniol**, Limonene**. (*Ingredient ecològic certificat / **Ingredient natural contingut en els olis essencials)",
        usage:
          "Aplicar sobre la pell seca fent un suau massatge. Ús diari com a hidratant corporal.",
        precautions:
          "Un cop obert mantenir en un lloc fresc i fosc. Indicat per a zones danyades de la pell. Es pot utilitzar com a aftersun i després de la depilació.",
        img: "/images/products/terra_santa_leche_corporal_regeneradora.PNG",
        video: "https://www.youtube.com/watch?v=casXEgFpFRQ",
      },
    ],
...
const checkProductsList = (lang) => {
  if (
    !translations[lang].productsList ||
    translations[lang].productsList.length === 0
  ) {
    console.warn(
      `⚠️ TRANSLATION WARNING: productsList is empty in ${lang.toUpperCase()}`,
    );
  }
};

checkProductsList("es");
checkProductsList("en");
checkProductsList("ca");
